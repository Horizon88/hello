...
raw = json.load(open("/tmp/fazwaz_south.json"))
...
# Coast anchor set for Southern Thailand (Andaman + Gulf)
COAST_TH_S = [
    # Andaman (west) — north to south
    (10.00,98.75),(9.50,98.36),(8.20,98.30),(7.90,98.30),
    (7.63,98.60),(7.30,99.10),(7.00,99.35),(6.65,99.65),(6.55,100.10),
    # Gulf (east) — south to north
...
existing = [e for e in existing if "src:fazwaz-southth" not in (e.get("rb","") or "")]
